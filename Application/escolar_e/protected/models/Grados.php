 ...
 * @property integer $licenciatura
 *
 * The followings are the available model relations:
 * @property Grado grado0
 */
class Grados extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('licenciatura', 'numerical', 'integerOnly'=>true),
			array('grado', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_grado, grado, licenciatura', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(			
			'grado0'=>array(self::HAS_MANY, 'Grado', 'grado')
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('licenciatura',$this->licenciatura);
