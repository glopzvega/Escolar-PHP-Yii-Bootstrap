 ...
 * @property RequisitosSeccion[] $requisitosSeccions
 */
class Requisitos extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('requisito, descripcion', 'required'),
			array('requisito, descripcion', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_requisito, requisito, descripcion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'requisitosSeccions' => array(self::HAS_MANY, 'RequisitosSeccion', 'requisito'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('id_requisito',$this->id_requisito);
