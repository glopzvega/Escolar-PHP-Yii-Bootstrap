...
class Laboral extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('trabaja', 'numerical', 'integerOnly'=>true),
			array('empresa, puesto, horario, telefono', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_laboral, trabaja, empresa, puesto, horario, telefono', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'alumnos' => array(self::HAS_MANY, 'Alumno', 'laboral'),
		);
	}
